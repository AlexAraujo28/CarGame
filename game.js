 ...
 * SPRITES
 ***********************************************************************/
function __CarSprite() { 
__sprite_init__(this, CarSprite, 64, 64, 0, 0, 'Box', 64, 0, 64, 0, 64, ['img/CarSprite_2.png']);
}; var CarSprite = new __CarSprite();

function __RocketSprite() { 
__sprite_init__(this, RocketSprite, 31, 75, 0, 0, 'Box', 15, 0, 31, 0, 75, ['img/RocketSprite_0.png']);
}; var RocketSprite = new __RocketSprite();

function __enemySprite() { 
__sprite_init__(this, enemySprite, 64, 64, 0, 0, 'Box', 64, 0, 64, 0, 64, ['img/enemySprite_1.png']);
}; var enemySprite = new __enemySprite();

function __sprite_54() { 
__sprite_init__(this, sprite_54, 500, 100, 0, 0, 'Box', 50, 0, 500, 0, 100, ['img/sprite_54_3.png']);
 ...
 * BACKGROUNDS
 ***********************************************************************/
function __background_7() { 
__background_init__(this, background_7, 'img/race track no lines.png')}; var background_7 = new __background_7();
 ...
 ***********************************************************************/
function __CarObj() {
__instance_init__(this, CarObj, null, 1, 0, CarSprite, 1, 0);
...
with(this) {
this.other = this.place_meeting(this.x, this.y, enemyObj);
if(this.other != null) {
visible = false
x = 200
visible = true
...
}; var CarObj = new __CarObj();

function __RocketObj() {
__instance_init__(this, RocketObj, null, 1, 0, RocketSprite, 1, 1);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var RocketObj = new __RocketObj();

function __enemyObj() {
__instance_init__(this, enemyObj, null, 1, 0, enemySprite, 1, 2);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var enemyObj = new __enemyObj();

function __object_55() {
__instance_init__(this, object_55, null, 1, 0, sprite_54, 1, 9);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
...
this.objects = [
[{o:CarObj, x:270, y:530}],
[{o:enemyObj, x:130, y:10}],
[{o:enemyObj, x:190, y:340}],
[{o:enemyObj, x:320, y:60}],
[{o:enemyObj, x:100, y:260}],
[{o:enemyObj, x:420, y:0}],
[{o:object_55, x:40, y:0}]];
this.start = function() {
__room_start__(this, scene_4, 500, 600, 30, 0, 0, 0, background_7.image, 0, 0, 1, 900, 600, null, 50, 50);
};
}
var scene_4 = new __scene_4();
tu_scenes.push(scene_4);
tu_room_to_go = scene_4;
